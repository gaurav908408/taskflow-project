...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-emerald-500/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-teal-500/20 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="p-8 sm:p-12 bg-gradient-to-br from-emerald-950/40 via-slate-900 to-slate-900 border-b lg:border-b-0 lg:border-r border-slate-800/80 flex flex-col justify-between">
          <div>
            ...
            <div className="mt-10">
              <h2 className="text-3xl font-extrabold text-white tracking-tight leading-tight">
                Join TaskFlow. <br />
                <span className="text-emerald-400">Streamline your team workflow.</span>
              </h2>
              <p className="mt-3 text-slate-400 text-sm leading-relaxed">
                Create an account to manage projects, assign tasks, and track productivity across your entire organization.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 space-y-3">
            <div className="flex items-center gap-3 text-xs font-semibold text-slate-300">
              ...
              <span>Unlimited Project & Task Workspace</span>
            </div>
            <div className="flex items-center gap-3 text-xs font-semibold text-slate-300">
              <FaCheckCircle className="text-emerald-400 text-sm" />
              <span>Kanban Drag-and-Drop Task Management</span>
            </div>
            <div className="flex items-center gap-3 text-xs font-semibold text-slate-300">
              <FaCheckCircle className="text-emerald-400 text-sm" />
              <span>Instant Team Setup & Real-time Updates</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 sm:p-12 flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm mt-1">
              Fill in your details to set up your new workspace.
            </p>
          </div>
